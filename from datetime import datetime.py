"""
Modelos SQLAlchemy para Padaria Bom Pão.
Arquivo contém as 6 entidades solicitadas (Customer, Supplier, Product, Inventory, Order, OrderItem)
e a BaseModel com created_at/updated_at/active.
"""
__all__ = [
    "Base", "BaseModel",
    "Customer", "Supplier",
