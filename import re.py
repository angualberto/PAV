"""
Módulo de validações (CPF, email, checagem de estoque).

Observação: o nome do arquivo contém espaço — mantenha como está no seu sistema de arquivos.
"""
__all__ = ["clean_digits", "is_valid_cpf", "is_valid_email", "can_process_order"]
